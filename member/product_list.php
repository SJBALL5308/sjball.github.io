...
include('connections1.php');  //ไฟล์เชื่อมต่อกับ database ที่เราได้สร้างไว้ก่อนหน้าน้ี
...
echo  ' <table class="table table-hover">';
  ...
  {echo "<tr>";
    ...
    //แก้ไขข้อมูล
    echo "<td><a href='product_form_edit.php?act=edit&ID=$row[0]' class='btn btn-warning btn-xs'>edit</a></td> ";
