		...
		<div class="container">
			<div class="d-flex justify-content-center h-100">
				<div class="card">
					...
					<div class="card-body">
						<form ame="formlogin" action="checklogin1.php" method="POST" id="login" class="form-horizontal">
							...
							<div class="form-group">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="rrrrr.php"><input type="button" value="สมัครสมาชิก" class="btn float-left login_btn2"></a>
